 ...
 */
export default function Import_Inspection_HU_SealsWSealsBtnPress(clientAPI) {

    console.log("MDK01 Import_Inspection_HU_SealsWSealsBtnPress");
    ...
    if (tu._HandlingUnitAudit.quantity >= cantGC) {
        ...
        return clientAPI.executeAction({
            ...
            console.log("MDK01 Import_Inspection_HU_SealsWSealsBtnPress error");
            clientAPI.getPageProxy().setActionBinding(tu);      
            clientAPI._control.setEnabled(true);   
            return clientAPI.executeAction({
                "Name": "/MDK01/Actions/GenericToastMessage.action",
            ...
            console.log("MDK01 Import_Inspection_HU_SealsWSealsBtnPress catch");
            clientAPI.getPageProxy().setActionBinding(tu);     
            clientAPI._control.setEnabled(true);    
            return clientAPI.executeAction({
                "Name": "/MDK01/Actions/GenericToastMessage.action",
